...
import com.app.twishchat.TwishChat;
...
public abstract class BaseActivity extends AppCompatActivity implements ServiceConnection {
    ...
    protected TwishChat application() {
        return (TwishChat) getApplication();
    }
    ...
    public final void joinChannel(final String channel, int uid) {
        String accessToken = ConstantApp.OUTGOING? ConstantApp.ACCESS_TOKEN : ConstantApp.RECEIVE_ACCESS_TOKEN;
    ...
    public final void generateToken(String uid) {
        RequestQueue reqQueue = Volley.newRequestQueue(this);
        reqQueue.add(new JsonObjectRequest(Request.Method.GET,
                "http://agoravideocalling.herokuapp.com/access_token?channel="+uid+"&uid=",
                null, response -> {
            try {
                ConstantApp.ACCESS_TOKEN = response.getString("token");
