...
public class ConstantApp {
    ...
    public static String RECEIVE_ACCESS_TOKEN;
    public static String ACTION_KEY_RECEIVER_ID;
    public static String ACTION_KEY_PROFILE_PIC;
    public static String ACTION_KEY_ROOM_ID;
    public static boolean OUTGOING;
    public static boolean CALLING_START;
    public static boolean CALL_LOADED;
